          ...
          {products.map((p, i) => (
            <div key={i} className="bg-card border border-border rounded-lg overflow-hidden">
              ...
              <div className="bg-background px-8 pt-8 pb-6 text-white border-white">
                ...
                <h3 className="text-2xl md:text-3xl font-bold mb-3 text-white bg-[#7a2424]/0">{p.title}</h3>
                <p className="text-sm leading-relaxed text-white bg-white/0">{p.description}</p>
              </div>
